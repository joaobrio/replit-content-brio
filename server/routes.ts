...
// Usar auth específico baseado no ambiente
const authModule = process.env.VERCEL ? "./vercelAuth" : "./replitAuth";
...
// Configure multer for file uploads (agora usa /tmp na Vercel)
const upload = multer({
...
// [RESTO DO CÓDIGO CONTINUA IGUAL - apenas mudei o import e a configuração do multer]
// Todo o resto do arquivo permanece exatamente como está...
